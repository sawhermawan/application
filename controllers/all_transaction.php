...
class All_transaction extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('admin/Static','admin/All_transaction',$data);
	}
	...
	public function ReceiptDetail()
	{
		...
		$this->template->load('admin/Static','admin/All_trans_detail',$data);
	}
	...
	public function UsedDetail()
	{
		...
		$this->template->load('admin/Static','admin/All_trans_detail_ship',$data);
	}
