...
class Receipt_inv extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/Receipt_inv',$data);
	}
	...
	public function tambah()
	{
...

		{
			...
			redirect('Receipt_inv/view/'.$pembelian_id);
		}
	...
	public function cetak()
	{
		...
		$this->load->view('logistic/Print_receipt_inv',$data);
	...
	public function view()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/Detail_receipt_inv',$data);
	}
	...
	public function tambahDetail()
	{
		...
		if ($date_receipt <= $lock_date_inv['date_lock_inv']) {
			...
			if ($CountItem > 0) {
				...
				redirect('Receipt_inv/view/'.$this->input->post('pembelian_id'));
			}else {
