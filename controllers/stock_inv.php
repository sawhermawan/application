...
class Stock_inv extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/Stock_inv',$data);
	}

	public function ViewDetailStock_inv()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/ViewDetailStock_inv',$data);
	}
