...
class Shipping_inv extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/Shipping_inv', $data);
	}
	...
	public function tambah()
	{
		...
		if ($pemakaian_date <= $lock_date_inv['date_lock_inv']) {
	    	...
	    	redirect('Shipping_inv/edit/'.$pemakaian_id);
	...
	public function cetak()
	{
		...
		$this->load->view('logistic/Print_shipping_inv',$data);
	...
	public function edit()
	{
		...
		$this->template->load('logistic/Static_inv','logistic/Detail_shipping_inv',$data);
	}
	...
	public function tambahDetail()
	{
		...
		if ($date_shipping <= $lock_date_inv['date_lock_inv']) {
			...
			if ($CountItem > 0) {
				...
				redirect('Shipping_inv/edit/'.$this->input->post('pemakaian_id'));
			}else {
