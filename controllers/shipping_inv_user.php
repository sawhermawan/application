...
class Shipping_inv_user extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('staff/Static_staff','staff/Shipping_inv_user', $data);
	}
	...
	public function tambah()
	{
		...
		if ($pemakaian_date <= $lock_date_inv['date_lock_inv']) {
	    	...
	    	redirect('Shipping_inv_user/edit/'.$pemakaian_id);
	...
	public function cetak()
	{
		...
		$this->load->view('staff/Print_shipping_inv_user',$data);
	...
	public function edit()
	{
		...
		$this->template->load('staff/Static_staff','staff/Detail_shipping_inv_user',$data);
	}
	...
	public function tambahDetail()
	{
		...
		if ($date_shipping <= $lock_date_inv['date_lock_inv']) {
			...
			if ($CountItem > 0) {
				...
				redirect('Shipping_inv_user/edit/'.$this->input->post('pemakaian_id'));
			}else {
