                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalCategory" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/kategori_barang/tambah')?>" method="post" enctype="multipart/form-data" role="form">
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalcategoryEdit" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/kategori_barang/update')?>" method="post" enctype="multipart/form-data" role="form">
              ...
              <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <form class="form-horizontal" action="<?php echo base_url('index.php/kategori_barang/delete')?>" method="post" enctype="multipart/form-data" role="form">
