                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_add_transfer" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/tambahDetail')?>" method="post" enctype="multipart/form-data" role="form">
         ...
         <script type="text/javascript">
            ...
            $(document).ready(function(){
              $("#category").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Transfer/GetCategoryItem/",
                  data:dataString,
                  cache:false,
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Transfer/GetItemMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#unitId").html(data);
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Transfer/GetItemCategoryMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#category").html(data);
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModaleditDetail" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/editInvTrans')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/post')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPostReceipt" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/postReceipt')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/deleteDetail')?>" method="post" enctype="multipart/form-data" role="form">
