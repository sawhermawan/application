          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <!-- Dashboard Master -->
                <li><a><i class="fa fa-share"></i> Master <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                   <li><a href="<?php echo base_url('index.php/Employee');?>">Employee</a></li> 
                    <li><a href="<?php echo base_url('index.php/Login_akses');?>">Login Akses</a></li>
                    
                    <li><a>Inventory Master<span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="<?php echo base_url('index.php/group_barang');?>">Group Barang</a></li>
                        <li><a href="<?php echo base_url('index.php/kategori_barang');?>">Kategori Barang</a></li>
                        <li><a href="<?php echo base_url('index.php/Inventory_unit');?>">Unit</a></li>
                        <li><a href="<?php echo base_url('index.php/Inventory_item');?>">Barang</a></li>
                        <li><a href="<?php echo base_url('index.php/daftar_harga');?>">Daftar Harga</a></li>
                        <li><a href="<?php echo base_url('index.php/Unit_conversion');?>">Unit Konversi</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-share"></i> Management Inventory <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    
                    </li>
                    
                        <li><a href="<?php echo base_url('index.php/pembelian');?>">Pembelian</a></li>
                        <li><a href="<?php echo base_url('index.php/Shipping');?>">Pemakaian</a></li>
                       <!--  <li><a href="<?php echo base_url('index.php/Transfer');?>">Transfer</a></li> -->
                        <li><a href="<?php echo base_url('index.php/Stock');?>">Stock</a></li>
                        <li><a href="<?php echo base_url('index.php/All_transaction');?>">History</a></li>
                ...
                <!-- Dashboard Setup -->
                <li><a><i class="fa fa-share"></i> Setup <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url('index.php/Unit');?>">Unit</a></li>
                ...
                <!-- Dashboard report -->
                <li><a href="<?php echo base_url();?>index.php/Report"><i class="fa fa-wpforms"></i> Report</a></li>
                <!-- end Dashboard report -->

                <!-- Dashboard system log -->
                <!-- end Dashboard system log -->
              </ul>
            </div>
          </div>
          <!-- /sidebar menu -->
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="<?php echo base_url();?>images/<?php echo $this->session->userdata('pic'); ?>" alt=""><?php echo $this->session->userdata('name'); ?>
