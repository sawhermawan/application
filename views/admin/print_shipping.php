                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h2 class="text-center">
                            <font color="#00000"><u>SURAT PENGELUARAN BARANG</u></font>
                          </h2>
                        </div>
                        <!-- /.col -->
                      </div>
                        ...
                        <div class="col-sm-6 invoice-col text-right">
                          <font color="#00000">
                            <?php if (empty($cetak->asset_id)): ?>
                              <b>Used To :</b> <?php echo $cetak->fullname;?> || <?php echo $cetak->nama_unit;?>
                            <?php else: ?>
                              <b>Used To :</b> <?php echo $cetak->desc_asset;?>
                            <?php endif; ?>
                            <br><br><b>Date :</b> <?php echo $cetak->pemakaian_date;?>
                          </font>
                        </div>
                      </div>
                      <?php endforeach; ?>
                      ...
                      <div class="row no-print">
                        <div class="col-xs-12">
                          ...
                          <a href="<?php echo base_url('index.php/Shipping')?>" id="backButton" title="Click to Edit" class="btn btn-info">Back</a>
                        </div>
                      </div>
                    </section>
                  </div>
