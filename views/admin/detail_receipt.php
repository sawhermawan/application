                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_add_receipt" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/pembelian/tambahDetail')?>" method="post" enctype="multipart/form-data" role="form">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($m_receipt as $rece): ?>
                          ...
                          <td><?php echo $rece->status;?></td>
                            ...
                            <td><a href="<?php echo base_url('index.php/pembelian')?>" >
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
              $("#category").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/pembelian/GetCategoryItem/",
                  data:dataString,
                  cache:false,
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/pembelian/GetItemMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#unitId").html(data);
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/pembelian/GetItemCategoryMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#category").html(data);
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModaleditDetail" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/pembelian/editInvTrans')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/pembelian/post')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost1" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/pembelian/post1')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/pembelian/deleteDetail')?>" method="post" enctype="multipart/form-data" role="form">
