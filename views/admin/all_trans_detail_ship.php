                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">New Used</h4>
                            </div>
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping/tambah')?>" method="post" enctype="multipart/form-data" role="form">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                  <select name="group_barang" id="group" class="text-center form-control" onchange="ShowGroup();" required>
                              ...
                              <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <select class="text-center form-control" name="loc">
                                    <option value="">Select Location</option>
                                    <?php foreach ($m_lokasi as $loc): ?>
                                      <option value="<?php echo $loc->id_lokasi;?>"><?php echo $loc->nama_lokasi?></option>
                                    <?php endforeach ?>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <select class="text-center form-control" name="no_asset">
                        ...
                        <tr>
                          ...
                          <td class="text-center"> 
                            ...
                            <?php elseif ($shipping->group_barang == 'SPR' && $shipping->status_shipping == 'Open'): ?>
                              <a id="delete" title="Click to Edit" data-toggle="modal" data-target="#myModalEditShipiing" data-id="<?php echo $shipping->id_pakai;?>" data-ship="<?php echo $shipping->pemakaian_id;?>" data-shidate="<?php echo $shipping->pemakaian_date;?>" data-loc="<?php echo $shipping->location_from;?>" data-user="<?php echo $shipping->id_userShipping;?>" data-asset="<?php echo $shipping->asset_id;?>" data-desc="<?php echo $shipping->desc_shiiping;?>" data-group="<?php echo $shipping->group_barang;?>" data-type="<?php echo $shipping->shipping_type;?>" data-unit="<?php echo $shipping->unitId_shipping;?>">
                                <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                              </a>
                            <?php elseif($shipping->group_barang == 'STO' && $shipping->status_shipping == 'Posted'): ?>
                              <a id="delete" title="Click to Edit" data-toggle="modal" data-target="#myModalEditShipiingATKPost" data-id="<?php echo $shipping->id_pakai;?>" data-ship="<?php echo $shipping->pemakaian_id;?>" data-shidate="<?php echo $shipping->pemakaian_date;?>" data-loc="<?php echo $shipping->location_from;?>" data-user="<?php echo $shipping->id_userShipping;?>" data-asset="<?php echo $shipping->asset_id;?>" data-desc="<?php echo $shipping->desc_shiiping;?>" data-group="<?php echo $shipping->group_barang;?>" data-unit="<?php echo $shipping->unitId_shipping;?>" data-type="<?php echo $shipping->shipping_type;?>">
                                <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                              </a>
                            <?php elseif ($shipping->group_barang == 'SPR' && $shipping->status_shipping == 'Posted'): ?>
                              <a id="delete" title="Click to Edit" data-toggle="modal" data-target="#myModalEditShipiingPost" data-id="<?php echo $shipping->id_pakai;?>" data-ship="<?php echo $shipping->pemakaian_id;?>" data-shidate="<?php echo $shipping->pemakaian_date;?>" data-loc="<?php echo $shipping->location_from;?>" data-user="<?php echo $shipping->id_userShipping;?>" data-asset="<?php echo $shipping->asset_id;?>" data-desc="<?php echo $shipping->desc_shiiping;?>" data-group="<?php echo $shipping->group_barang;?>" data-type="<?php echo $shipping->shipping_type;?>" data-unit="<?php echo $shipping->unitId_shipping;?>">
                                <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                              </a>
                            <?php endif; ?>
                            ...
                            <?php if($shipping->status_shipping == 'Open'): ?>
                              <a href="<?php echo base_url('index.php/Shipping/edit/'.$shipping->pemakaian_id)?>" title="Click to View Detail" class="btn btn-info"><i class="fa fa-eye"></i></a>

                              <a href="<?php echo base_url('index.php/Shipping/cetak/'.$shipping->pemakaian_id)?>" title="Click to Print" class="btn btn-dark"><i class="fa fa-print"></i></a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalEditShipiingATK" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping/editUsed')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping/delete')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-delete">
                          <div class="row">
          ...
          function selectuser()
            {
               var location = $('#location').val();
                ...
                $.post('<?php echo base_url();?>index.php/Shipping/getUser/',
              {
                location:location
