                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalTransfer" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/tambah')?>" method="post" enctype="multipart/form-data" role="form">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo base_url('index.php/Transfer/edit/'.$transfer->transfer_id)?>" title="Click to Edit" class="btn btn-info"><i class="fa fa-eye"></i></a>

                            <a href="<?php echo base_url('index.php/Transfer/cetak/'.$transfer->transfer_id)?>" title="Click to Edit" class="btn btn-dark"><i class="fa fa-print"></i></a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalTransferEdit" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/editTransfer')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Transfer/delete')?>" method="post" enctype="multipart/form-data" role="form">
