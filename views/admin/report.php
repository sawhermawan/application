                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="x_panel fixed_height_320">
                        <div class="x_title">
                          <h2>Report <small>Keluar Masuk Barang</small></h2>
                          <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPengeluaranBarang" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/report/stock')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-delete">
                          <div class="row">
                            <!-- <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
