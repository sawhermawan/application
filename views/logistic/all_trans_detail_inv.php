            ...
            <div class="page-title">
              ...
              <div class="pull-right">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo base_url('index.php/All_transaction_inv')?>">All Transaction</a></li>
                        ...
                        <?php foreach ($m_receipt as $rec): ?>
                          ...
                          <td class="text-center">
                            <?php if($rec->status == 'Open'): ?>
                              ...
                              <a href="<?php echo base_url('index.php/Receipt_inv/view/'.$rec->pembelian_id)?>" title="Click to View Detail" class="btn btn-info"><i class="fa fa-eye"></i></a>

                              <a href="<?php echo base_url('index.php/Receipt_inv/cetak/'.$rec->pembelian_id)?>" title="Click to Print" class="btn btn-dark"><i class="fa fa-print"></i></a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalEditReceipt" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv/edit')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv/delete')?>" method="post" enctype="multipart/form-data" role="form">
