                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h2 class="text-center">
                            <font color="#00000"><u>SURAT PEMBELIAN BARANG</u></font>
                          </h2>
                        </div>
                      ...
                      <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                          <font color="#00000">
                             <p align="Justify"><?php echo $cetak->nama_suplayer; ?></p>
                          </font>
                        </div>
                        <div class="col-sm-2 invoice-col text-right">
                          <font color="#00000">
                             <b>No Telp Suplayer :</b>
                          </font>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          <font color="#00000">
                             <p align="Justify"><?php echo $cetak->no_telp_suplayer; ?></p>
                          </font>
                        </div>
                        ...
                        <div class="col-sm-4 invoice-col">
                          <font color="#00000">
                             <p align="Justify"><?php echo $cetak->alamat_suplayer; ?></p>
                          </font>
                        </div>
                        ...
                        <div class="col-sm-4 invoice-col">
                          <font color="#00000">
                             <p align="Justify"><?php echo $cetak->email_suplayer; ?></p>
                          </font>
                        </div>
                      </div>
                        ...
                        <div class="col-xs-12 table">
                          <table class="table table-striped" rules="rows" border="1">
                            ...
                            <tbody>
                              ...
                              <?php endforeach ?>
                              <?php foreach($totbeli as $tot): ?>
                              <tr>
                               <td colspan="5" class="text-right">Total Harga  :</td>
                               <td>Rp.<?php echo number_format($tot->total,2,',','.') ?></td>
                              </tr>
                              <?php endforeach ?>
                      ...
                      <div class="row no-print">
                        <div class="col-xs-12">
                          ...
                          <a href="<?php echo base_url('index.php/Receipt_inv')?>" id="backButton" title="Click to Edit" class="btn btn-info">Back</a>
                        </div>
                      </div>
                    </section>
                  </div>
