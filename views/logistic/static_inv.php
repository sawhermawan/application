          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                <li><a href="<?php echo base_url();?>index.php/Admin_inv"><i class="fa fa-home"></i>Home</a></li>

                <!-- Dashboard Maser Asset -->
                  <li><a><i class="fa fa-share"></i> Master <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url(); ?>index.php/Category_item_inv">Kategori Barang</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/Inventory_item_inv">Barang</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/Inventory_unit_inv">Unit</a></li>            
                   <!--  <li><a href="<?php echo base_url(); ?>index.php/Inventory_price_inv">Price</a></li> -->
                    <li><a href="<?php echo base_url(); ?>index.php/Unit_conversion_inv">Unit Conversion</a></li>
                  </ul>
                </li>
                <!-- End Dashboard Master Asset -->

                <!-- Dashboard Management -->
                <li><a><i class="fa fa-share"></i>Invetory Management <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url(); ?>index.php/Receipt_inv">Order</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/Shipping_inv">Used</a></li>
                    <!-- <li><a href="<?php echo base_url(); ?>index.php/Transfer_inv">Transfer</a></li> -->
                    <li><a href="<?php echo base_url(); ?>index.php/Stock_inv">Stock</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/All_transaction_inv">History</a></li>
                  </ul>
                </li>
