          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Order <small>Detail</small></h3>
              </div>
                  ...
                  <div class="x_title">
                    <div class="row">
                      <div class="col-lg-6">
                        ...
                        <?php else: ?>
                          <h3>View <small>Order Detail</small></h3>
                        <?php endif; ?>
                      </div>
                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_add_receipt" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/receipt_inv/tambahDetail')?>" method="post" enctype="multipart/form-data" role="form">

                            <div class="modal-body">
                              <div class="row">

                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <select class="text-center form-control" id="category" name="category" onchange="selectitem()">
                                ...
                                <!-- <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  ...
                                  <?php foreach ($m_daftar_harga as $daftar): ?>
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($m_receipt as $rece): ?>
                          ...
                          <tr>
                          <!-- <td><input type="checkbox" name="id_barang" value=""></td> -->
                         ...
                         <!--  <td><?php echo $rece->harga;?></td>
                          <td>$hasil_rupiah = "Rp " . number_format($angka,2,',','.');</td> -->
                          <td>Rp.<?php echo number_format($rece->harga,2,',','.') ?></td>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($m_receipt as $rece): ?>
                          ...
                          <td><?php echo $rece->status;?></td>
                            ...
                            <td><a href="<?php echo base_url('index.php/receipt_inv')?>" >
          ...
          function selectitem()
              {
                 var itemId = $('#itemId').val();
                  ...
                  $.post('<?php echo base_url();?>index.php/pembelian/GetItemMaster/',
                {
                  itemId:itemId
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
              $("#category").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/receipt_inv/GetCategoryItem/",
                  data:dataString,
                  cache:false,
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/receipt_inv/GetItemMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#unitId").html(data);
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/receipt_inv/GetItemCategoryMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#category").html(data);
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModaleditDetail" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/receipt_inv/editInvTrans')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/receipt_inv/post')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost1" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/receipt_inv/post1')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/receipt_inv/deleteDetail')?>" method="post" enctype="multipart/form-data" role="form">
