              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <div class="row">
                      <div class="col-lg-6">
                        <button type="button" class="btn btn-success btn-sm" title="New" data-toggle="modal" data-target="#myModalShipping"><i class="fa fa-plus"></i></button><b>Pengeluaran barang</b>
                      </div>
                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalShipping" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv/tambah')?>" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <tr>
                          ...
                          <td class="text-center"> 
                            <?php if ($shipping->status_shipping == 'Open'): ?>
                              ...
                              <a href="<?php echo base_url('index.php/Shipping_inv/edit/'.$shipping->pemakaian_id)?>" title="Click to View Detail" class="btn btn-info"><i class="fa fa-eye"></i></a>

                              <a href="<?php echo base_url('index.php/Shipping_inv/cetak/'.$shipping->pemakaian_id)?>" title="Click to Print" class="btn btn-dark"><i class="fa fa-print"></i></a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalEditShipiingATK" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv/editUsed')?>" method="post" enctype="multipart/form-data" role="form">
