                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_add_shipping" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv_user/tambahDetail')?>" method="post" enctype="multipart/form-data" role="form">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                  <select class="selectpicker show-tick form-control" id="itemId" name="id_barang" onchange="selectitem()" required="id_barang" data-live-search="true">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <?php foreach($m_shipping as $shipping): ?>
                        <tr>
                          ...
                          <td><?php echo $shipping->pemakaian_date; ?></td>
                          <td><?php echo $shipping->status; ?></td>
                           <td><a href="<?php echo base_url('index.php/Shipping_inv_user')?>" >
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
              $("#category").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Shipping_inv_user/GetCategoryItem/",
                  data:dataString,
                  cache:false,
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Shipping_inv_user/GetItemMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#unitId").html(data);
            ...
            $(document).ready(function(){
              $("#itemId").change(function(){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url();?>index.php/Shipping_inv_user/GetItemCategoryMaster/",
                  data:dataString,
                  cache:false,
                 success:function(data){
                    $("#category").html(data);
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModaleditDetail" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv_user/editInvTrans')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalPost" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv_user/post')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Shipping_inv_user/deleteDetail')?>" method="post" enctype="multipart/form-data" role="form">
