              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <div class="row">
                      <div class="col-lg-6">
                        <button type="button" class="btn btn-success btn-sm" title="New" data-toggle="modal" data-target="#myModalReceipt"><i class="fa fa-plus"></i></button><b>Receipt</b>
                      </div>
                ...
                <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalReceipt" class="modal fade">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv_user/tambah')?>" method="post" enctype="multipart/form-data" role="form">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <input type="text" class="text-center form-control has-feedback-left" name="no_po_ax" placeholder="No PO AX" required="no_po_ax">
                                  <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <input type="text" class="text-center form-control" name="no_product_receipt_ax" placeholder="No Product Receipt AX" required="no_product_receipt_ax">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <select class="text-center form-control" name="receipt_type" required="receipt_type">
                        ...
                        <?php foreach ($m_receipt as $rec): ?>
                          ...
                          <td class="text-center">
                            <?php if($rec->status == 'Open'): ?>
                              <a id="edit" title="Click to Edit" data-toggle="modal" data-target="#myModalEditReceipt" data-id="<?php echo $rec->id;?>" data-rec="<?php echo $rec->pembelian_id;?>" data-rdate="<?php echo $rec->pembelian_date;?>" data-location="<?php echo $rec->location_id;?>" data-noax="<?php echo $rec->no_po_ax;?>" data-axr="<?php echo $rec->no_product_receipt_ax;?>" data-axdate="<?php echo $rec->receipt_ax_date;?>" data-desc="<?php echo $rec->description;?>" data-group="<?php echo $rec->group_barang;?>">
                                <button class="btn btn-success"><i class="fa fa-edit"></i></button>
                              </a>

                              <a href="<?php echo base_url('index.php/Receipt_inv_user/view/'.$rec->pembelian_id)?>" title="Click to View Detail" class="btn btn-info"><i class="fa fa-eye"></i></a>

                              <a href="<?php echo base_url('index.php/Receipt_inv_user/cetak/'.$rec->pembelian_id)?>" title="Click to Print" class="btn btn-dark"><i class="fa fa-print"></i></a>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalEditReceipt" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv_user/edit')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="form-control text-center has-feedback-left" disabled="disabled" id="pembelian_id" name="pembelian_id" placeholder="Receipt ID" required="pembelian_id">
                              <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <select class="text-center form-control" id="location_id" name="id_lokasi" required="id_lokasi">
                                  <option value="">Select Location</option>
                                  <?php foreach ($m_location as $loc): ?>
                                    <option value="<?php echo $loc->id_lokasi;?>"><?php echo $loc->location_name?></option>
                                  <?php endforeach ?>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="text-center form-control has-feedback-left" id="no_product_receipt_ax" name="no_product_receipt_ax" placeholder="No Product Receipt AX" required="no_product_receipt_ax">
                              <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span>
                            </div>
                ...
                <script type="text/javascript">
                  $(document).on("click","#edit", function() {
                    ...
                    $("#modal-edit #location_id").val(location_id);
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv_user/edit')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <select class="text-center form-control" id="location_id" disabled="disabled" name="id_lokasi" required="id_lokasi">
                                  <option value="">Select Location</option>
                                  <?php foreach ($m_location as $loc): ?>
                                    <option value="<?php echo $loc->id_lokasi;?>"><?php echo $loc->location_name?></option>
                                  <?php endforeach ?>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="text-center form-control has-feedback-left" disabled="disabled" name="pembelian_date" id="rdate" placeholder="Receipt Date" required="pembelian_date">
                              <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="text-center form-control" id="no_po_ax" disabled="disabled" name="no_po_ax" placeholder="No PO AX" required="no_po_ax">
                              <span class="fa fa-book form-control-feedback right" aria-hidden="true"></span>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="text-center form-control has-feedback-left" disabled="disabled" id="no_product_receipt_ax" name="no_product_receipt_ax" placeholder="No Product Receipt AX" required="no_product_receipt_ax">
                              <span class="fa fa-book form-control-feedback left" aria-hidden="true"></span>
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <input type="text" class="text-center form-control" name="receipt_ax_date" disabled="disabled" id="ax_date" placeholder="AX Date" required="receipt_ax_date">
                              <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
                            </div>
                            <input type="hidden" id="id" name="id">

                            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                              <select name="group_barang" id="group_barang" disabled="disabled" class="text-center form-control" required>
                                    <option value="">Select Item Group</option>
                                  <?php foreach ($m_group_barang as $group): ?>
                                    <option value="<?php echo $group->group_id;?>"><?php echo $group->group_barang;?></option>
                                  <?php endforeach ?>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv_user/delete')?>" method="post" enctype="multipart/form-data" role="form">
