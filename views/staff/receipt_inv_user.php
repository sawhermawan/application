 ...
 -->
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                  <select id="basic" class="selectpicker show-tick form-control" name="id_suplayer" required="id_suplayer" data-live-search="true">
                                      <option value="">Select Suplayer</option>
                                      <?php foreach ($m_suplayer as $supl): ?>
                                        <option value="<?php echo $supl->id_suplayer;?>"><?php echo $supl->nama_suplayer?></option>
                                      <?php endforeach ?>
                                    </select>
                                </div>
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/Receipt_inv_user/edit')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-edit">
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                              <select class="text-center form-control" id="id_lokasi" disabled="disabled" name="id_lokasi" required="id_lokasi">
                                  <option value="">Select Location</option>
                                  <?php foreach ($m_location as $loc): ?>
                                    <option value="<?php echo $loc->id_lokasi;?>"><?php echo $loc->nama_lokasi?></option>
                                  <?php endforeach ?>
                        ...
                        <div class="modal-body" id="modal-delete">
                          <div class="row">
                            ...
                            <div class="alert alert-info">
                              <p>Are you sure you want to delete the Order you check?.</p>
                            </div>
