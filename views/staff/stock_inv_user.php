                      ...
                      <?php foreach($m_stock_barang as $stock): ?>  
                        <tr>
                          ...
                          <!-- <td class="text-center">
                            ...
                            <!-- <a href="<?php echo base_url('index.php/Stock_inv_user/ViewDetailStock_inv_user/'.$stock->id)?>" title="Click to View Detail" class="btn btn-info"><i class="fa fa-eye"></i> View Detail</a> -->
                          </td>  -->
                        </tr>
                      <?php endforeach ?>
                      </tbody>
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalEditStock" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/stock/edit')?>" method="post" enctype="multipart/form-data" role="form">
